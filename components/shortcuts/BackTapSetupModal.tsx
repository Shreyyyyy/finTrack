...
export function BackTapSetupModal({ isOpen, onClose, userEmail }: BackTapSetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full max-h-[92vh] overflow-y-auto p-6 shadow-2xl border border-sky-100 dark:border-slate-800 space-y-6">
        {/* Modal Header */}
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-sky-100 dark:bg-emerald-500/20 text-sky-700 dark:text-emerald-400 flex items-center justify-center">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] uppercase font-black px-1.5 py-0.5 rounded bg-sky-100 dark:bg-emerald-950 text-sky-800 dark:text-emerald-300">
                  &lt; 5s Flow
                </span>
                <a
                  ...
                  className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-sky-50 dark:bg-blue-950 text-sky-700 dark:text-blue-400 hover:underline border border-sky-100 dark:border-transparent"
                >
                  Live Logs ↗
                </a>
              </div>
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-xl text-slate-400 hover:text-black dark:hover:text-white hover:bg-sky-50 dark:hover:bg-slate-800"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <button
              ...
              className={`py-1.5 rounded-xl text-xs font-bold text-center border transition-all ${
                activeStep === step
                  ...
                  : 'bg-sky-50 dark:bg-slate-800/60 text-slate-700 dark:text-slate-400 border-sky-100 dark:border-slate-700'
              }`}
            >
              Step {step}
            </button>
        ...
        {activeStep === 1 && (
          <div className="space-y-4">
            ...
            <div className="p-3.5 rounded-2xl bg-sky-50/70 dark:bg-slate-800/70 border border-sky-100 dark:border-slate-700 space-y-2">
              <div className="flex items-center justify-between text-xs font-bold text-slate-700 dark:text-slate-300">
                <span className="text-sky-800 dark:text-emerald-400">1-Click URL (Includes Key, No Headers Needed!)</span>
                <button
                  onClick={() => copyText(endpointUrlWithKey, false)}
                  className="text-sky-700 dark:text-emerald-400 font-bold flex items-center gap-1 hover:underline"
                >
                  {copiedUrl ? <Check className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
                  <span>{copiedUrl ? 'Copied' : 'Copy 1-Click URL'}</span>
                </button>
              </div>
              <div className="font-mono text-xs text-black dark:text-slate-200 bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-sky-100 dark:border-slate-700 break-all select-all font-semibold">
                {endpointUrlWithKey}
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-sky-600 text-white font-black text-xs flex items-center justify-center gap-1 hover:bg-sky-500 shadow-md shadow-sky-600/20"
            >
        ...
        {activeStep === 2 && (
          <div className="space-y-4">
            ...
            <div className="p-3.5 rounded-2xl bg-sky-50/70 dark:bg-slate-800/70 border border-sky-100 dark:border-slate-700 space-y-2">
              ...
              <div className="font-mono text-xs text-black dark:text-slate-200 bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-sky-100 dark:border-slate-700 break-all select-all font-black text-sky-700 dark:text-emerald-400">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="py-3 px-4 rounded-2xl border border-sky-100 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-sky-50"
              >
                Back
              </button>
              <button
                onClick={() => setActiveStep(3)}
                className="flex-1 py-3 rounded-2xl bg-sky-600 text-white font-black text-xs flex items-center justify-center gap-1 hover:bg-sky-500 shadow-md shadow-sky-600/20"
              >
        ...
        {activeStep === 3 && (
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <div className="p-3 rounded-2xl bg-sky-50/70 dark:bg-slate-800/60 border border-sky-100 dark:border-slate-700">
                <div className="font-bold text-black dark:text-white flex items-center gap-1.5 mb-1">
                ...
                <p className="text-slate-600 dark:text-slate-400 pl-6 font-medium">
              ...
              <div className="p-3 rounded-2xl bg-sky-50/70 dark:bg-slate-800/60 border border-sky-100 dark:border-slate-700">
                ...
                <div className="text-slate-600 dark:text-slate-400 pl-6 space-y-1 font-medium">
                  ...
                  <p className="pl-3 text-slate-700 dark:text-slate-300 font-semibold">
              ...
              <div className="p-3 rounded-2xl bg-sky-100/60 dark:bg-emerald-950/30 border border-sky-200 dark:border-emerald-800/60">
                <div className="font-bold text-black dark:text-white flex items-center gap-1.5 mb-1">
                ...
                <p className="text-slate-700 dark:text-slate-300 pl-6 font-medium">
        ...
        {activeStep === 4 && (
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-sky-50/80 dark:bg-emerald-950/20 border border-sky-200 dark:border-emerald-800/60 space-y-2 text-xs">
              <div className="flex items-center gap-2 font-bold text-sky-950 dark:text-emerald-300">
                <Sparkles className="w-4 h-4 text-sky-600" />
                <span>On your iPhone:</span>
              </div>
              <ol className="list-decimal list-inside space-y-1.5 text-slate-800 dark:text-slate-300 font-medium">
            ...
            <div className="p-3 rounded-2xl bg-sky-50/70 dark:bg-slate-800/40 border border-sky-100 dark:border-slate-700 text-xs text-slate-700 dark:text-slate-400 flex items-center gap-2 font-medium">
            ...
            <button
              onClick={onClose}
              className="w-full py-3.5 rounded-2xl bg-sky-600 text-white font-black text-xs flex items-center justify-center gap-1 hover:bg-sky-500 shadow-md shadow-sky-600/20"
            >
