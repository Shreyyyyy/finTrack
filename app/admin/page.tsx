  ...
  if (!isAdmin) {
    return (
      <div className="w-full max-w-md mx-auto px-4 py-10 sm:py-16 flex flex-col items-center">
        <div className="w-full bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-sky-100 dark:border-slate-800 shadow-2xl space-y-5">
          <div className="text-center space-y-2">
            <div className="w-14 h-14 mx-auto rounded-2xl bg-sky-100 dark:bg-emerald-500/20 border border-sky-200 dark:border-emerald-500/30 text-sky-600 dark:text-emerald-400 flex items-center justify-center shadow-lg shadow-sky-500/10">
              <ShieldAlert className="w-7 h-7" />
            </div>
            <h1 className="text-xl sm:text-2xl font-black tracking-tight text-black dark:text-white uppercase">
              DB Admin Console
            </h1>
            <p className="text-xs text-slate-700 dark:text-slate-400 font-medium leading-relaxed max-w-xs mx-auto">
              This console is isolated exclusively for system database administration. Please sign in with the DB Admin credentials.
            </p>
          </div>

          {user || currentProfile ? (
            <div className="p-3 rounded-2xl bg-sky-50/70 dark:bg-slate-800/60 border border-sky-200 dark:border-slate-700/80 text-xs">
          ...
          <form onSubmit={handleDirectAdminLogin} noValidate className="space-y-3.5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  readOnly
                  disabled
                  className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-sky-200 dark:border-slate-700 bg-sky-50/70 dark:bg-slate-800/50 text-xs font-mono font-bold text-black dark:text-slate-300 cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-sky-200 dark:border-slate-700 bg-sky-50/50 dark:bg-slate-800/80 text-xs font-bold text-black dark:text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:bg-white dark:focus:bg-slate-800 transition-all"
                  required
                  autoFocus
                />
                <button
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-sky-600 hover:bg-sky-500 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-black text-xs sm:text-sm shadow-md active:scale-98 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-3.5 sm:px-4 py-4 sm:py-6 md:py-8 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-5 border border-sky-100 dark:border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase tracking-wider text-slate-800 dark:text-slate-400">Registered Accounts</span>
            <Users className="w-4 h-4 text-sky-600" />
          </div>
          <div className="text-2xl font-black tracking-tight text-black dark:text-white mt-1">
            {usersSummary.length}
          </div>
          <div className="text-[11px] text-slate-700 dark:text-slate-400 font-medium mt-0.5">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-5 border border-sky-100 dark:border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase tracking-wider text-slate-800 dark:text-slate-400">Total Transactions</span>
            <ReceiptText className="w-4 h-4 text-sky-600" />
          </div>
          <div className="text-2xl font-black tracking-tight text-black dark:text-white mt-1">
            {allExpenses.length}
          </div>
          <div className="text-[11px] text-slate-700 dark:text-slate-400 font-medium mt-0.5">Across all registered people</div>
        </div>

        <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-5 border border-sky-100 dark:border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase tracking-wider text-slate-800 dark:text-slate-400">Total Volume Spent</span>
            <DollarSign className="w-4 h-4 text-rose-500" />
          </div>
          <div className="text-2xl font-black tracking-tight text-black dark:text-white mt-1">
            {formatINR(totalVolume)}
          </div>
          <div className="text-[11px] text-slate-700 dark:text-slate-400 font-medium mt-0.5">Cumulative lifetime entries</div>
        </div>

        <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-5 border border-sky-200 dark:border-emerald-500/30 bg-sky-50/30 dark:bg-emerald-500/[0.02] shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase tracking-wider text-slate-800 dark:text-slate-400">Database Engine</span>
            <Database className="w-4 h-4 text-sky-600 dark:text-emerald-500" />
          </div>
          <div className="text-sm font-black tracking-tight text-sky-700 dark:text-emerald-400 mt-1 flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-sky-600 dark:bg-emerald-500 animate-pulse" />
            <span>Supabase Central DB</span>
          </div>
          <div className="text-[10px] text-slate-700 dark:text-slate-400 font-mono mt-0.5 truncate">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h2 className="text-base font-black text-black dark:text-white flex items-center gap-2">
              ...
              <span className="text-xs font-normal text-slate-600 dark:text-slate-400">({usersSummary.length} profiles)</span>
            </h2>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h2 className="text-base font-black text-black dark:text-white flex items-center gap-2">
              ...
              <span className="text-xs font-normal text-slate-600 dark:text-slate-400">({filteredExpenses.length} entries)</span>
            </h2>
            <p className="text-xs text-slate-700 dark:text-slate-400 font-medium">
