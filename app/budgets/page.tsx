...
export default function BudgetsPage() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-5 md:py-8 space-y-8">
      ...
      {editingOverall ? (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-sky-300 dark:border-emerald-500/40 shadow-sm space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-3 py-2 text-sm rounded-xl bg-sky-50/70 dark:bg-slate-800 border border-sky-100 dark:border-slate-700 font-bold text-black dark:text-white"
                />
              </div>
            </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button
              ...
              className="px-4 py-2 text-xs font-semibold text-slate-600 hover:text-black"
            >
              Cancel
            </button>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {categories.map((cat) => {
            ...
            return (
              <div
                key={cat.id}
                className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-sky-100 dark:border-slate-800 shadow-sm space-y-3"
              >
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-700 dark:text-slate-400 font-medium">
                        Spent: <span className="font-bold text-black dark:text-slate-200">{formatINR(spent)}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    {isEditingThis ? (
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          className="w-20 px-2 py-1 text-xs rounded-lg bg-sky-50/70 dark:bg-slate-800 border border-sky-200 dark:border-slate-700 font-bold text-black dark:text-white"
                        />
                        <button
                      ...
                      <button
                        ...
                        className="group flex items-center gap-1 text-right text-xs hover:text-sky-600 transition-colors"
                      ...
                      >
                        <div>
                          ...
                          <div className="text-[10px] text-slate-500 group-hover:underline">
                            Edit limit
                          </div>
                        </div>
                      </button>
                ...
                {budget > 0 && (
                  <div className="space-y-1.5">
                    <div className="w-full bg-sky-100 dark:bg-slate-800 h-2.5 rounded-full overflow-hidden">
                      <div
